...
class BinTreeIterator<T extends Comparable<T>> implements Iterator<T> {
    ...
    public T next() {
        ...
        // Hints:
        //  - Find the node you need to return and save it
        //    in a temporary variable.
        //  - Update the iterator state (path and node fields) so
        //    that the next time you call this you'll return the
        //    next node.
        //  - The problem text gives exactly the steps to do this.

        // Another hint: Every time this method is called:
        //  - It's going to return the data field of the node next
        //    in an in-order tree traversal.
        //  - It'll have updated the this.node field to point somewhere
        //    after that in the traversal.
